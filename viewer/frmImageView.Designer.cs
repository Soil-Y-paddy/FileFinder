...
namespace viewer
{
	partial class frmImageView
	{
		...
		private void InitializeComponent()
		{
			...
			// statusStrip1
			// 
			statusStrip1.Items.AddRange(new ToolStripItem[] { lblRoot, toolStripStatusLabel2 });
			...
			// toolStrip1
			// 
			toolStrip1.Items.AddRange(new ToolStripItem[] { numImgNo, lblImgItem, toolStripSeparator1, cmbImgViewStyle, numImgZoom, lblImgZoom });
			...
			pict1.Image = null;
			pict1.Location = new Point(0, 0);
			pict1.Name = "pict1";
			pict1.ScrollMode = ScrollMode.ActualSize;
			pict1.Size = new Size(800, 426);
			pict1.TabIndex = 3;
			pict1.Visible = false;
			pict1.Zoom = 1F;
